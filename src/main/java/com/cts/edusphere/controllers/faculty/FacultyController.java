...
public class FacultyController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'DEPARTMENT_HEAD', 'STUDENT')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'DEPARTMENT_HEAD', 'STUDENT') or (hasRole('FACULTY') and #id == authentication.principal.userId)")
