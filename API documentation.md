...
|  5   |  `POST` | `/auth/change-password`  		| Change the user password 			|  All  |
...
|  4   |  `POST` | `/users/{id}` 	    		| Update a user by id				| Admin |
|  5   | `PATCH` | `/users/{id}` 	    		| Activate/Deactivate a user 			| Admin |
|  6   | `Delete`| `/users/{id}` 	    		| Get the a user by id				| Admin |
|  7   |  `POST` | `/users/{id}` 	    		| Update a user by id				| Admin |
...
|  6   |  `POST` | `/students/{id}` 	   	 	| Update a student by id			| Admin |
...
|  6   |  `POST` | `/faculties/{id}` 	    	    	| Update a Faculty by id			| Admin |
...
|  8   |  `GET`  | `/departments/{id}/facult` 	   	| Get list of faculties of a department		| Admin |
...
|  4   |  `POST` | `/curriculum/{id}` 	    	    	| Update a Curriculum by id			| Admin |
|  5   | `Delete`| `/curriculum/{id}` 	    	    	| Delete a Curriculum				| Admin |
|  6   |  `POST` | `/curriculum/{id}` 	    	    	| Update a Curriculum by id			| Admin |
...
|  4   |  `POST` | `/exams/{id}` 	    	    	| Update a Exam by id				| Admin |
|  5   | `Delete`| `/exams/{id}` 	    	    	| Delete a Exam					| Admin |
|  6   |  `POST` | `/exams/{id}` 	    	    	| Update a Exam by id				| Admin |
...
|  3   |  `POST` | `/grades/{id}` 	    	    	| Update a Grade by id				| Admin |
...
|  4   |  `POST` | `/workload/{id}` 	    	    	| Update a workload by id			| Admin |
...
|  5   |  `POST` | `/thesis/{id}` 	    	    	| Update a thesis by id				| Admin |
...
|  4   |  `POST` | `/notifications/{id}/read-all` 	| Mark all notifications as read		| Admin |
...
|  5   |  `POST` | `/audits/{id}`		 	| Update audit details				| Admin |
...
|  5   |  `POST` | `/reports/{id}/status`		| Update a report status			| Admin |
